          ...
          <div className="cb-prompts-grid">
            ...
            {QUICK_PROMPTS.map(
              (p, i) => (
                ...
                >
                  <span className="cb-prompt-icon">
                    {p.icon}
                  </span>

                  <span className="cb-prompt-text">
                    {p.text}
                  </span>
      ...
      <div className="cb-messages">
        ...
        {messages.map(
          (msg, i) => (
            <div
              key={i}
              className={`cb-message cb-message--${
                msg.role ===
                "user"
                  ? "user"
                  : "bot"
